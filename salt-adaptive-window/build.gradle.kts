...
mavenPublishing {
    ...
    coordinates(
        ...
        artifactId = "salt-adaptive-window",
        version = project.version.toString()
    )

    // Configure POM metadata for the published artifact
    pom {
        name.set("Salt Adaptive Window")
        description.set(
            "Adaptive Window Components for Compose Multiplatform (Android/Desktop/iOS)"
        )
...
kotlin {
    ...
    android {
        namespace = "com.moriafly.salt.adaptive.window"
        compileSdk = 37
        minSdk = 23
