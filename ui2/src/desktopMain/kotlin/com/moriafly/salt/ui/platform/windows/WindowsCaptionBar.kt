...
@Composable
internal fun rememberWindowsCaptionBarFontIconFamily(): State<FontFamily?> {
    val fontIconFamily = remember { mutableStateOf<FontFamily?>(null) }
    // Get Windows system font icon, if failed fall back to Fluent Svg icon
...
@UnstableSaltUiApi
@Composable
internal fun WindowsCaptionButtonFullscreen(
    onClick: () -> Unit,
...
@UnstableSaltUiApi
@Composable
internal fun WindowsCaptionButtonMinimize(
    onClick: () -> Unit,
    iconFontFamily: FontFamily?,
    modifier: Modifier = Modifier,
    enabled: Boolean = true
...
@UnstableSaltUiApi
@Composable
internal fun WindowsCaptionButtonMaximize(
    onClick: () -> Unit,
    iconFontFamily: FontFamily?,
    maximized: Boolean,
    modifier: Modifier = Modifier,
...
@UnstableSaltUiApi
@Composable
internal fun WindowsCaptionButtonClose(
    onClick: () -> Unit,
    iconFontFamily: FontFamily?,
    modifier: Modifier = Modifier,
    enabled: Boolean = true
...
internal val WindowsCaptionButtonWidth = 46.83f.dp
