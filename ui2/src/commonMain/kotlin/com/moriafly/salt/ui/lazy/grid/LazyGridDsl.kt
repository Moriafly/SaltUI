...
import androidx.compose.ui.unit.dp
import com.moriafly.salt.ui.gestures.ScrollableDefaults
...
interface GridCells {
    ...
    class Fixed(
        ...
        override fun Density.calculateCrossAxisCellSizes(
            availableSize: Int,
            spacing: Int,
        ): List<Int> = calculateCellsCrossAxisSizeImpl(availableSize, count, spacing)

        override fun hashCode(): Int {
            return -count // Different sign from Adaptive.
        }

        override fun equals(other: Any?): Boolean = other is Fixed && count == other.count
    }
    ...
    class Adaptive(
        ...
        override fun equals(other: Any?): Boolean = other is Adaptive && minSize == other.minSize
    }
    ...
    class FixedSize(
        ...
        override fun equals(other: Any?): Boolean = other is FixedSize && size == other.size
    }
}
