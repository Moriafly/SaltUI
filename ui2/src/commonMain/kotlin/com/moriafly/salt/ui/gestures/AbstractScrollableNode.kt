...
/** Base class for a one-dimensional [ScrollableNode]. */
internal abstract class AbstractScrollableNode(
    ...
    private fun updateDefaultFlingBehavior() {
        ...
        defaultFlingBehavior.updateDensity(requireDensity())
    }
    ...
    override fun startDragImmediately(): Boolean = scrollLogic.shouldScrollImmediately()
}
