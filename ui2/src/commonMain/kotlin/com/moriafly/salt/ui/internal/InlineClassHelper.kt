...
internal fun throwIllegalStateException(message: String): Unit =
    throw IllegalStateException(message)

internal fun throwIllegalStateExceptionForNullCheck(message: String): Nothing =
    throw IllegalStateException(message)

internal fun throwIllegalArgumentException(message: String): Unit =
    throw IllegalArgumentException(message)

internal fun throwIllegalArgumentExceptionForNullCheck(message: String): Nothing =
    throw IllegalArgumentException(message)

internal fun throwIndexOutOfBoundsException(message: String): Unit =
