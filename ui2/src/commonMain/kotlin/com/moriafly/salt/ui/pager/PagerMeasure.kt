...
import com.moriafly.salt.ui.gestures.snapping.calculateDistanceToDesiredSnapPosition
    ...
    return if (pageCount <= 0) {
        ...
        val positionedPagesBefore =
            if (extraPagesBefore.isEmpty()) {
                ...
                positionedPages.fastFilter { it.index < visiblePages.first().index }
            }
        ...
        val positionedPagesAfter =
            if (extraPagesAfter.isEmpty()) {
                ...
                positionedPages.fastFilter { it.index > visiblePages.last().index }
            }
...
private fun calculateNewCurrentPage(
    ...
    snapPosition: SnapPosition,
    pageCount: Int,
): MeasuredPage? = visiblePagesInfo.fastMaxBy {
    -abs(
